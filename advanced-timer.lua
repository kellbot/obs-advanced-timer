...
function settings_modified(props, prop, settings)
	...
	local p_rest = obs.obs_properties_get(props, "rest)
	...
	obs.obs_property_set_visible(p_rest, false)
	...
	elseif (mode_setting == "HIIT") then
		obs.obs_property_set_visible(p_duration, true)
		obs.obs_property_set_visible(p_rest, true)
		obs.obs_property_set_visible(p_year, false)
		obs.obs_property_set_visible(p_month, false)
		obs.obs_property_set_visible(p_day, false)
		obs.obs_property_set_visible(p_hour, false)
...
function script_properties()
	...
	obs.obs_property_list_add_string(p_mode, "HIIT", "hiit")
	...
	obs.obs_properties_add_int(props, "rest", "Rest duration (seconds)", 1, 10000000, 1)
...
function script_defaults(settings)
	...
	obs.obs_data_set_default_int(settings, "rest", 10)
